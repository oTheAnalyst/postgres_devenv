...
CREATE TABLE postgres_db.staging.true_saving AS SELECT
        *
FROM
        read_csv('./data/true_savings.csv');
CREATE TABLE postgres_db.staging.checking AS SELECT
        *
FROM
        read_csv('./data/checking.csv');
CREATE TABLE postgres_db.staging.tax_account AS SELECT
        *
FROM
